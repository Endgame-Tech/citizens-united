...
export default function PublicCauseDetail() {
  ...
  if (supporterCount < 10000) {
    milestoneText = "Growing to 10000 supporters";
  } else if (supporterCount < 100000) {
    milestoneText = "Over 10,000 supporters, growing to 100,000";
  } else if (supporterCount < 500000) {
    milestoneText = "Over 100,000 supporters, growing to 500,000";
  } else if (supporterCount < 1000000) {
    milestoneText = "Over 500,000 supporters, growing to 1,000,000";
  } else {
    milestoneText = "Over 1,000,000 supporters, and growing";
  }
