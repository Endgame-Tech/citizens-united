import { Clock, DollarSign, FileText, Building, Landmark, CheckCircle } from "lucide-react";

const TrackGovernance = () => {
  return (
      ...
      <div className="relative w-full rounded-xl overflow-hidden mb-6 md:mb-10 bg-gradient-to-r from-green-700 to-green-500">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-6 md:p-10">
          <div className="text-white max-w-xl mb-6 md:mb-0">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3">Track – Monitor Governance</h1>
            <p className="text-lg md:text-xl opacity-90 mb-4">
              Democracy without accountability is broken. The Republic makes public information public again.
            </p>
          </div>
        </div>
      </div>
...
const features = [
  {
    title: "Budgets",
    description: "Visualised summaries with progress reports to help citizens understand where public money is being spent.",
  ...
  {
    title: "Bills",
    description: "Legislative bills explained with AI, including pros/cons to make legal documents accessible to everyone.",
    icon: <FileText className="text-indigo-600 h-6 w-6" />,
    bgColor: "bg-indigo-50",
    source: "placbillstrack.org"
  },
  {
    title: "Projects",
    description: "Verified by citizens, tagged by location, with contractor and completion data for maximum transparency.",
    icon: <Building className="text-amber-600 h-6 w-6" />,
    bgColor: "bg-amber-50",
    source: "Tracka"
  },
  {
    title: "Policies",
    description: "Government policies explained with timelines and expected impact to help citizens understand implications.",
...
const steps = [
  {
    ...
    description: "Choose to monitor budgets, bills, projects, or policies in your area of interest."
  },
  {
    title: "View Simplified Data",
    description: "Access complex government information presented in easy-to-understand visual formats."
  },
  {
    title: "Track Progress & Updates",
    description: "Follow implementation timelines and receive notifications about changes or updates."
  },
  {
    title: "Provide Citizen Oversight",
    description: "Add your verification or comments as a form of community-based monitoring."
  },
  {
    title: "Share Insights",
    description: "Easily share governance data with your community to increase awareness and accountability."
  }
];

export default TrackGovernance;