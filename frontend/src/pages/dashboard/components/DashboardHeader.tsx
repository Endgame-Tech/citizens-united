...
export default function DashboardHeader({ title, isSidebarOpen, toggleSidebar, setActivePage }: DashboardHeaderProps) {
  ...
  return (
    <header className="w-full px-6 py-4 bg-white border-b border-gray-300 flex justify-between items-center font-poppins shadow-sm relative z-20">
      ...
      <div className="flex items-center gap-3 relative" ref={dropdownRef}>
        ...
        {dropdownOpen && (
          <div className="absolute right-0 top-12 w-[340px] bg-white shadow-xl rounded-lg overflow-hidden border border-gray-200 z-50 animate-fadeIn">
              ...
              <a
                ...
                onClick={(e) => {
                  ...
                  if (typeof setActivePage === 'function') {
                    setActivePage('All Notifications');
                  }
                }}
              >
