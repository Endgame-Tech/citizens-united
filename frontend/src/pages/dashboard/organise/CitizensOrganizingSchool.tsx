...
const CitizensOrganizingSchool = () => {
  ...
  const airtableFormUrl = "https://airtable.com/app3AgwviZqsdPLIH/shrLOyH9djxDZGVzr";

  return (
    <div className="font-poppins py-20 ">
      {/* Hero Section */}
      {/* <div className="relative bg-gradient-to-r from-[#006837] to-[#8cc63f] overflow-hidden py-12 md:py-20">
        <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white text-center relative z-10">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            Citizens Organising School
          </h1>

          <div className="max-w-3xl mx-auto">
            <p className="text-xl md:text-2xl mb-8">
              Building a movement of 5 million organizers to transform Nigeria
            </p>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[#006837] rounded-full text-lg font-semibold hover:bg-gray-100 transition-all shadow-lg transform hover:scale-105"
            >
      ...
      <div className="mb-16">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-10 text-gray-800">
          Welcome to the Citizens Organising School
        </h2>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800">Powered by the Citizens United Platform</h3>
              </div>
            ...
            {expandedSection === "platform" && (
              <div className="px-6 pb-6">
                <p className="text-gray-700 mb-4">Every participant will be trained to use the Citizens United digital platform, your one-stop civic tech toolkit to:</p>
                <ul className="space-y-3">
                  {[
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <h3 className="text-xl font-semibold text-gray-800">Your Journey at Citizens Organising School</h3>
              </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      {[
                        ...
                        "Full walkthrough and application of the Citizens United Platform"
                      ].map((item, index) => (
